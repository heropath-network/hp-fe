      ...
      <div class="ml-auto flex items-center gap-3">
        <template v-if="selectedTab === 'positions' && positions.length > 0">
          <button
            ...
            class="rounded bg-red-600 px-3 py-1.5 text-xs font-medium text-white transition hover:bg-red-500"
          >
            Close All
          </button>
        </template>
        ...
        <template v-if="selectedTab === 'history' && tradeHistory.length > 0">
          <button
            @click="exportHistory"
            class="flex items-center gap-1.5 rounded bg-gray-700 px-3 py-1.5 text-xs font-medium text-white transition hover:bg-gray-600"
          >
