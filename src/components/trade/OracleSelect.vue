<template>
  <div class="flex items-center gap-3">
    ...
    <Menu as="div" class="relative inline-block text-left">
      <div>
        <MenuButton
          class="flex items-center gap-2 rounded-lg border border-gray-800 bg-gray-900 px-3 py-1.5 text-sm text-gray-300 transition hover:border-gray-700 focus:border-blue-500 focus:outline-none"
        >
